...
import com.example.sunnyweather.databinding.ActivityFlipPageBinding
...
class CardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        card = binding.ivCard
        val closeIcon = binding.ivFlipPageClose
        val beam = binding.ivBeam
        val prise = binding.ivFlipPagePrise
        val button = binding.ivFlipPageCloseButton
        val hint = binding.ivFlipPageHint
        val bottom = binding.ivFlipPageButtom
        ...
        CoroutineScope(Dispatchers.Main).launch {
            ...
            val scaleX6 = ObjectAnimator.ofFloat(card, View.SCALE_X, 1f, 2f)
            val scaleY6 = ObjectAnimator.ofFloat(card, View.SCALE_Y, 1f, 2f)
