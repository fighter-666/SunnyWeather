...
import com.example.sunnyweather.activity.CardActivity
import com.example.sunnyweather.activity.TestActivity
import com.example.sunnyweather.databinding.ViewGroupCustomFlipCardBinding
import com.example.sunnyweather.util.DensityUtils
...
class CustomFlipCardViewGroup : ConstraintLayout {
    ...
    private val myActivityLauncher =
        (context as TestActivity).registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { activityResult ->
    ...
    private fun initView(context: Context) {
        ...
        binding.ivFirstCard.setOnClickListener {
            ...
            val options = ActivityOptionsCompat.makeSceneTransitionAnimation(
                context as TestActivity,
                binding.ivFirstCard, "transition_image"
            )
