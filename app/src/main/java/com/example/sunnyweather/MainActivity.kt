        ...
        if (customView != null) {
            ...
            val tabIcon = customView.findViewById<ImageView>(R.id.tabIcon)
                ...
                if (isSelected) {
                    ...
                    tabName.setTextColor(Color.BLUE);
                    when (position) {
                        0 -> {
                            tabIcon.setImageResource(R.drawable.ic_recommend)
                        }
                        1 -> {
                            tabIcon.setImageResource(R.drawable.ic_recommend)
                        }
                    ...
                    when (position) {
                        0 -> {
                            tabIcon.setImageResource(R.drawable.ic_sunny)
                        }
                        1 -> {
                            tabIcon.setImageResource(R.drawable.ic_knowledge)
                        }
                        2 -> {
                            tabIcon.setImageResource(R.drawable.ic_message)
                        }
                        3 -> {
                            tabIcon.setImageResource(R.drawable.ic_mine)
                        }
                    }
                }
        }
