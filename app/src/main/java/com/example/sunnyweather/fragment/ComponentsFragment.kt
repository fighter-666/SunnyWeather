...
class ComponentsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val piggies = listOf(
            ...
            Pair(R.mipmap.icon_grid_tip_dialog, "VariousTextviewActivity"),
            Pair(R.mipmap.icon_grid_tip_dialog, "QWUIDrawableHelper"),
            Pair(R.mipmap.icon_grid_tip_dialog, "FeedStreamHomePageActivity"),
            Pair(R.mipmap.icon_grid_tip_dialog, "WebViewActivity"),
